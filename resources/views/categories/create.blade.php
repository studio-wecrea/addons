...
<body class="flex bg-gray-100 min-h-screen">
  ...
  <div class="px-4 py-8 mx-auto">
      <h2 class="mb-8 text-xl font-bold text-gray-900 dark:text-white">Create Category</h2>
      <form class="" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data" runat="server">
        @csrf
