...
<body class="flex bg-gray-100 min-h-screen">
  ...
  <div class="px-4 py-8 mx-auto">
      <h2 class="mb-8 text-xl font-bold text-gray-900 dark:text-white">Edit Category</h2>
      <form class="" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data" runat="server">
        @csrf
        @method('PUT')
          <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
              ...
              <div>
                  ...
                  <img id="avatar" src="{{ $category->image }}" class="w-10 h-10 rounded-full mr-4">
              ...
              <div class="sm:col-span-2">
                  ...
                  <input id="description" name="description" value="{{ $category->description }}" rows="8" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Write a product description here..."></input>
              </div>
          </div>
