    ...
    <div class="col-span-3">
        ...
        <div class="px-4 py-3 shadow flex items-center gap-4">
            ...
            <div class="flex-grow">
                ...
                @if(!empty($customer))
                <h4 class="text-smtext-gray-800 font-medium">
        ...
        <div class="mt-6 bg-white shadow rounded p-4 divide-y divide-gray-200 space-y-4 text-gray-600">
            ...
            <div class="space-y-1 pl-8">
                <a href="#" class="text-smrelative hover:text-yellow-600 block font-medium capitalize transition">
                    <span class="absolute -left-8 top-0 text-base">
                        <i class="far fa-address-card"></i>
                    </span>
                    Manage account
                </a>
                <a href="{{route('customers.profile-edit')}}" class="relative hover:text-yellow-600 block capitalize transition">
                    Profile info
                </a>
                <a href="{{route('customers.address')}}" class="relative hover:text-yellow-600 block capitalize transition">
                    Manage address
                </a>
                <a href="{{route('customers.password')}}" class="relative hover:text-yellow-600 block capitalize transition">
                    Change password
                </a>
            </div>
            <!-- single link end -->
            ...
            <div class="space-y-1 pl-8 pt-4">
                <a href="{{route('orders.history')}}" class="relative text-yellow-600 block font-medium capitalize transition">
                    <span class="absolute -left-8 top-0 text-base">
                        <i class="fa fa-gift"></i>
                    </span>
                    My Order History
                </a>
                <a href="#" class="relative hover:text-yellow-600 block capitalize transition">
                    My Returns
                </a>
                <a href="#" class="relative hover:text-yellow-600 block capitalize transition">
                    My Cancellations
            ...
            <!-- single link -->
            <div class="space-y-1 pl-8 pt-4">
                <a href="#" class="relative hover:text-yellow-600 block font-medium capitalize transition">
                    <span class="absolute -left-8 top-0 text-base">
            ...
            <!-- single link -->
            <div class="space-y-1 pl-8 pt-4">
                <a href="{{route('orders.wishlist')}}" class="relative hover:text-yellow-600 block font-medium capitalize transition">
                    <span class="absolute -left-8 top-0 text-base">
