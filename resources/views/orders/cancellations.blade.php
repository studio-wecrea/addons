...
<div class="container py-4 flex items-center gap-3">
        ...
        <p class="text-sm text-gray-600 font-medium">My Cancellations</p>
</div>
<!-- breadcrums end -->
<!-- Account wrapper -->
<div class="container grid grid-cols-12 items-start gap-6 pt-4 pb-16">
    ...
    <div class="col-span-3">
        ...
        <div class="mt-6 bg-white shadow rounded p-4 divide-y divide-gray-200 space-y-4 text-gray-600">
            ...
            <div class="space-y-1 pl-8 pt-4">
                ...
                <a href="{{route('orders.cancellations')}}" class="text-sm relative hover:text-yellow-600 block capitalize transition">
                    My Cancellations
                </a>
                <a href="#" class="text-sm relative hover:text-yellow-600 block capitalize transition">
                    My Reviews
    ...
    <div class="py-4 flex items-center gap-3">
        ...
        <p class="text-sm text-gray-600 font-medium">Cancellations</p>
    </div>
