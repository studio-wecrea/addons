   ...
   <footer class=" bg-white pt-10 pb-12 border-t border-gray-100 pb-16 items-start">
        <div class="container grid grid-cols-1 md:grid-cols-3">
            ...
            <div class="col-span-1 space-y-4">
                ...
                <p class="text-gray-500 text-sm text-justify pr-20">
                    Liquorice powder lollipop chupa chups chocolate bar cake gummies.
                </p>
                ...
                <div class="grid grid-cols-2 gap-8">
                    <div>
                        ...
                        <div class="mt-4 space-y-4">
                            ...
                            <a href="#" class="text-sm text-gray-500 hover:text-gray-900 block">Commerce</a>
                            <a href="#" class="text-sm text-gray-500 hover:text-gray-900 block">Insights</a>
                        </div>
                    </div>
                    <div>
                        <h3 class="text-sm font-semibold text-gray-400 uppercase tracking-wider">Support</h3>
                        <div class="mt-4 space-y-4">
                            <a href="#" class="text-sm text-gray-500 hover:text-gray-900 block">Pricing</a>
                            <a href="#" class="text-sm text-gray-500 hover:text-gray-900 block">Documentation</a>
                            <a href="#" class="text-sm text-gray-500 hover:text-gray-900 block">Guides</a>
                            <a href="#" class="text-sm text-gray-500 hover:text-gray-900 block">API status</a>
                        </div>
                    </div>
