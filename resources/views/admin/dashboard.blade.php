        ...
        <main class="p-6 sm:p-10 space-y-6">
            <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                <div class="mr-6">
                    ...
                    <h2 class="text-gray-600 ml-0.5">Wecrea Addons</h2>
                </div>
                <div class="flex flex-wrap items-start justify-end -mb-3">
                    <button class="inline-flex px-5 py-3 text-yellow-600 hover:text-yellow-900 focus:text-yellow-900 hover:bg-yellow-500 focus:bg-yellow-500 border border-yellow-600 rounded-md mb-3">
                        <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="flex-shrink-0 h-5 w-5 -ml-1 mt-0.5 mr-2">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                        </svg>
                        Manage dashboard
                    </button>
                    <button id="dropdownDefault" data-dropdown-toggle="dropdown" class="inline-flex px-5 py-3 text-white bg-yellow-600 hover:bg-yellow-900 focus:bg-yellow-900 rounded-md ml-6 mb-3">
                    ...
                    <div id="dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                            <li>
                                <a href="{{ route('modules.create') }}" class="block w-44 py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white ">Add new Module</a>
                            </li>
                            <li>
                                <a href="#" class="block w-44 py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Add new Platform</a>
                            </li>
                            <li>
                                <a href="#" class="block w-44 py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Add new Category</a>
                            </li>
                        </ul>
                    </div>
                </div>
