...
<body class="flex bg-gray-100 min-h-screen">
  ...
  <div class="px-10 py-8 mx-auto">
      <h2 class="mb-8 text-xl font-bold text-gray-900 dark:text-white">Platform</h2>
    
          <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
              <div class="sm:col-span-2">
                  <label for="image" class="block mb-2 text-sm font-medium text-gray-700">Photo</label>
                  <div class="inline-flex w-full">
                  <img id="avatar" src="{{ $platform->image }}" class="w-10 h-10 rounded-full mr-4">
                  </div>
              </div>
              <div class="w-full">
                  <h5 for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$platform->name}}</h5>
              </div>
              <div class="w-full">
                  <h5 for="slug" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$platform->slug}}</h5>
              </div>
              
              <div class="sm:col-span-2">
                  <h5 for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$platform->description}}</h5>
              </div>
          </div>
          <div class="flex items-center space-x-4">
              <a href="{{ route ('platforms.edit', $platform->id) }}" class="text-white bg-primary hover:bg-primary-900 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                  Edit
              </a>
