...
@endif
  ...
  <div class="px-4 py-8 mx-auto">
      <h2 class="px-40 mb-8 text-xl font-bold text-gray-900 dark:text-white">Create Customer</h2>
      <form id="form-test" action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
          <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5 px-40">
              ...
              <label for="image" class="block mb-6 text-sm font-medium text-gray-900 dark:text-white">Upload Avatar</label>
                <div class="inline-flex w-full">
                  <img id="avatar" src="{{ url('/images/profile.png') }}" class="w-16 h-16 rounded-full mr-4">
              ...
              <input name="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="" placeholder="Type phone number" required="">
              </div>
              <div>
              ...
              <div class="sm:col-span-2">
                  ...
                  <input id="address" name="address" rows="8" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Write an address here..."></input>
              </div>
          </div>
