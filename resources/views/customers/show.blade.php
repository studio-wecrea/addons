...
@endif
  ...
  <div class="px-4 py-8 mx-auto">
      <h2 class="px-40 mb-8 text-xl font-bold text-gray-900 dark:text-white">Customer</h2>
          <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5 px-40">
              ...
              <h5 for="firstname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$customer->firstname}}</h5>
              </div>
              <div class="w-full">
              <h5 for="lastname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$customer->lastname}}</h5>
              </div>
              <div class="w-full">
              <h5 for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$customer->email}}</h5>
              </div>
              <div class="w-full">
              <h5 for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$customer->phone}}</h5>
              </div>
              <div>
                  <h5 for="role" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$customer->role}}</h5>
              </div>
              <div class="sm:col-span-2">
                  <h5 for="address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$customer->address}}</h5>
              </div>
          </div>
          <div class="px-40 flex items-center space-x-4">
              <a href="{{ route('customers.edit', $customer->id)}}" class="text-white bg-primary hover:bg-primary-900 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                  Edit
              </a>
