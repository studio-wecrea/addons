        ...
        <div class="col-span-9 shadow rounded px-6 pt-5 pb-7">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <!-- single input -->
                        <div>
                            <label for="country" class="text-sm text-gray-600 mb-2 block">Country</label>
                        ...
                        <!-- single input -->
                        <div>
                            <label for="region" class="text-sm text-gray-600 mb-2 block">Region</label>
                            <input type="text" name="region" class="input-box">
                        </div>
                        <!-- single input end -->
                </div>
                <!-- form row end -->
                ...
                <div class="grid grid-cols-2 gap-4">
                    <!-- single input -->
                        <div>
                            <label for="zip_code" class="text-sm text-gray-600 mb-2 block">Zip Code</label>
                            <input type="text" name="zip_code" class="input-box">
                        </div>
                        <!-- single input end -->
                        <!-- single input -->
                        <div>
                            <label for="gender" class="text-sm text-gray-600 mb-2 block">City</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <!-- single input -->
                        <div>
                            ...
                            <input type="email" name="email" class="input-box" @if(!empty($user->email)) value="{{$user->email}}" @endif>
                        </div>
                        <!-- single input end -->
                        <!-- single input -->
                        <div>
